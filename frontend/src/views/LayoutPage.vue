<template>
  <v-container fluid class="pa-0">
    ...
    <div style="margin-top: 2rem; width: 100%; display: flex; justify-content: space-between">
      <v-btn
        variant="text"
        size="x-large"
...
export default {
  ...
  setup() {
    ...
    watch(
      ...
      (isDark) => {
        document.documentElement.style.setProperty('--checkbox-color', isDark ? 'white' : 'black')
      },
      { immediate: true }
    )
